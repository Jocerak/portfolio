...
import { Mail, Github, Linkedin, ExternalLink, Code2, Cloud, Zap, Server, ArrowRight } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      {/* Navigation */}
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? "bg-white shadow-lg border-b border-gray-200" : "bg-transparent"}`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="text-lg font-bold text-orange-600">JR</div>
          <div className="flex gap-8">
            <a href="#experience" className="text-sm text-gray-600 hover:text-orange-600 transition-colors font-medium">Experience</a>
            <a href="#skills" className="text-sm text-gray-600 hover:text-orange-600 transition-colors font-medium">Skills</a>
            <a href="#contact" className="text-sm text-gray-600 hover:text-orange-600 transition-colors font-medium">Contact</a>
          </div>
        </div>
      </nav>
            ...
            <div className="flex-1 space-y-8 animate-fade-in max-w-md">
              <div className="space-y-4">
                <div className="inline-block">
                  <span className="px-4 py-2 bg-orange-100 text-orange-700 text-sm font-bold rounded-full">DevOps Engineer</span>
                </div>
                <h1 className="text-6xl sm:text-7xl font-bold text-gray-900 leading-tight">
                  Jocelyn<br />RAKOTOMALALA
                </h1>
              ...
              <p className="text-xl text-gray-700 leading-relaxed max-w-md font-light">
                Administrateur Système DevOps spécialisé dans l'automatisation, la conteneurisation et l'infrastructure as code. Je transforme les déploiements complexes en pipelines fiables et efficaces.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <a href="mailto:rakotomalala.jocelyn@yahoo.fr" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-orange-600 text-white font-bold hover:bg-orange-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
                  <Mail size={20} />
                  Me contacter
                </a>
                <a href="#" className="inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-gray-400 text-gray-900 font-bold hover:border-orange-600 hover:text-orange-600 hover:bg-orange-50 transition-all duration-300">
                  Voir CV
      ...
      <section id="experience" className="py-24 px-4 sm:px-6 lg:px-8 relative">
        <div className="absolute inset-0 z-0 opacity-5">
          <img 
            src="/images/automation-pattern.png" 
          ...
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 group">
              ...
              <div className="md:col-span-3 border-l-4 border-orange-600 pl-8 pb-8 hover:pl-10 transition-all duration-300">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Automatisation des déploiements et mise en place de pipelines CI/CD avec Jenkins et GitLab pour automatiser le processus de build, test et déploiement des applications.
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 group">
              ...
              <div className="md:col-span-3 border-l-4 border-orange-600 pl-8 pb-8 hover:pl-10 transition-all duration-300">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Gestion complète de l'infrastructure système, administration des serveurs Windows et Linux, mise en place de solutions de backup et maintenance des systèmes critiques.
                </p>
                <div className="flex flex-wrap gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 group">
              ...
              <div className="md:col-span-3 border-l-4 border-orange-600 pl-8 pb-8 hover:pl-10 transition-all duration-300">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Infogérance de clients multiples, déploiement SCCM/MECM, gestion Intune et Autopilot, intégration et déploiement des mises à jour Windows 10, gestion des packages applicatifs.
                </p>
                <div className="flex flex-wrap gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 group">
              ...
              <div className="md:col-span-3 border-l-4 border-orange-600 pl-8 hover:pl-10 transition-all duration-300">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Administration complète de l'infrastructure, gestion du parc informatique, support technique et maintenance des systèmes.
                </p>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="space-y-3">
                <div className="flex flex-wrap gap-2">
                  {["Docker", "Kubernetes", "Terraform", "Ansible", "Jenkins", "GitLab CI", "GitHub"].map((skill) => (
                    <span key={skill} className="px-4 py-2 bg-gradient-to-r from-orange-50 to-orange-100 border border-orange-300 text-gray-800 text-sm rounded-lg hover:border-orange-600 hover:shadow-md transition-all duration-300 font-medium">
                      {skill}
                    </span>
                  ))}
                </div>
            ...
            {[
              {
                ...
                title: "Administrateur Système DevOps - Niveau 6",
                company: "G2R, Paris"
              },
              {
                period: "2011 - 2014",
                title: "Licence en Informatique",
                company: "Institut de Formation Technique (IFT), Madagascar"
              },
              {
                period: "2010",
                title: "Baccalauréat Série D",
                company: "Lycée Saint-Pierre Canisius, Madagascar - Mention Bien"
              }
            ].map((edu, idx) => (
      ...
      <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <a href="tel:+33766587374" className="inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-orange-600 text-orange-400 font-bold hover:bg-orange-600 hover:text-white transition-all duration-300">
              <ArrowRight size={20} />
              +33 7 66 58 73 74
            </a>
          </div>
